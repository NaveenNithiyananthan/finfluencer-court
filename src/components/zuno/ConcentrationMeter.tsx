...
export function ConcentrationMeter({ weights }: { weights: Weights }) {
  ...
  return (
    <div className="surface-card animate-fade-up p-5">
      ...
      <div className="relative mt-4 h-2 rounded-full" style={{ background: "var(--gradient-risk)" }}>
        <span
          className="absolute top-1/2 size-5 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-primary bg-white shadow-md transition-[left] duration-500 ease-out"
