...
export function CourtEntryCard({ variant }: { variant: "hero" | "feature" }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-court/30 bg-card p-6 shadow-[var(--shadow-card)] sm:p-8">
      <div
        aria-hidden
        className="pointer-events-none absolute -right-20 -top-24 size-64 rounded-full bg-court opacity-15 blur-3xl"
      />
      <div className="relative">
        <div className="flex items-center gap-2">
          <span className="grid size-8 place-items-center rounded-full border border-court/40 text-court">
